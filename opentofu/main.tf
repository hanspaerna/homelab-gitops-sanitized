...
resource "proxmox_vm_qemu" "k3s_control_plane" {
  ...
  balloon = var.control_plane_memory
  ...
  dynamic "usb" {
    for_each = var.zigbee_usb_port_id != null ? toset([var.zigbee_usb_port_id]) : []
    content {
      id = 0
      port_id = usb.value
      usb3 = true
  ...
  content = templatefile("inventory.tmpl",
    {
      ...
      control_plane_external_ipv6_network = hcloud_server.k3s_control_plane_external.ipv6_network
    }
  )
